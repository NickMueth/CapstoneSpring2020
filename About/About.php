...
<body>
    ...
    <div class="grid-container">
        <div class="Osvaldo">
            ...
            <img class="cover-photo" src="About_Images/Ozzy_Cover.jpg" alt="Osvaldo Sanchez Cover Photo">
            <p>
        ...
        <div class="Nick">
            <h2> Nick Mueth </h2>
            <img class="cover-photo" src="About_Images/Nick_Cover.jpg" alt="Nicholas Mueth Cover Photo">
            <p>
                <span id="b">Class:</span> Senior at SEMO
                <br>
                <span id="b">Degree:</span> CIS Bachelors
        ...
        <div class="Josh">
            <h2> Joshua Toth </h2>
            <img class="cover-photo" src="About_Images/Josh_Cover.jpg" alt="Joshua Toth Cover Photo">
            <p>
                <span id="b">Class:</span> Senior at SEMO
                <br>
                <span id="b">Degree:</span> CIS Bachelors
        ...
        <div class="Parfait">
            ...
            <img class="cover-photo" src="About_Images/Parfait_Cover.jpg" alt="Parfait Domagni Cover Photo">
            <p>
                <span id="b">Class:</span> Senior at SEMO
                <br>
                <span id="b">Degree:</span> CIS Bachelors
