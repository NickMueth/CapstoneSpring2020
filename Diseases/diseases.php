    ...
    <div class="diseases">    
        <?php
            ...
            while($row = $disresult->fetch_assoc()){
                ...
                if($dis_common != null){
                        echo '<a href="Clicked Disease.php?disease_id=' . $dis_id . '" id="' . $dis_common . '">' . $dis_name . ' (' . $dis_common . ')</a>';
                } else{
                    echo '<a href="Clicked Disease.php?disease_id=' . $dis_id . '" id="' . $dis_name . '">' . $dis_name . '</a>';
