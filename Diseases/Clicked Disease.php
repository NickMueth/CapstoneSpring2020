...
<head>
    ...
    ?>
<link rel="stylesheet" type="text/css" href="Clicked_Disease.css">    
</head>
        ...
        <div class="wbg">
            ...
            <ul>
                <li class="breadcrumbs-item">
                    <a href="diseases.php" class="breadcrumbs-link">Diseases</a>
                </li>
                <li class="breadcrumbs-item">
                    ...
                    <?php
                        if($connect_bd->num_rows > 0){
                            ...
                            while($row = $connect_bd->fetch_assoc()){
                                ...
                                echo '<li><a href="../Home/breed.php?breed_id=' . $bre_id . '">' . $bre_name . '</a></li>';
                            }
                            echo '</ul></div>';
                        }
