...
<body>
        ...
        <form name="symptomForm" action="results.php" onsubmit="return formValidation()" method="POST">
    ...
    <script>
            ...
            coll[i].addEventListener("click", function(){
                ...
                for(var j = 0;j<cont.length;j++){
                    if(cont[j].id == sym_area){
                        ...
                        //var sym_area_content = document.getElementById(cont[j]);
                        //sym_area_content.style.display = "block";
                    } else {
        ...
        $(':checkbox').change(function(){
            ...
            /*if(selected!=null){
                //$("#checked_symptoms").empty();
                for(var x = 0;x<selected.length;x++){
                    $("#checked_symptoms").prepend("<p>"+selected[x]+", </p>");
                }
            }*/
