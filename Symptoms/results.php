    ...
    <div class="page-container">
        ...
        <div class="summary">
            ...
            <?php 
                ...
                if(PythiosisCheck() == true){
                    echo '<h5 style="padding:10px;">Your dog\'s age makes them more susceptible to <a href="../Diseases/Clicked Disease.php#Pythiosis">Pythiosis</a>.</h5>';
                }
                if(BlastomycosisCheck() == true){
                    echo '<h5 style="padding:10px;">Your dog\'s average weight makes them more susceptible to <a href="../Diseases/Clicked Disease.php#Blastomycosis">Blastomycosis</a>.</h5>';
                }
                //Check for the severity level of Von Willebrand's Disease
                switch(VonWillebrandSeverityCheck()){
                    case 1:
                    ...
                    <?php
                        ...
                        foreach($results as $rows){
                            ...
                            if($rows[1]>=75){
                                ...
                                echo '<tr class="bg-danger dis" style="font-size:1.5rem;"><td><a style="color:white;" href="../Diseases/Clicked Disease.php#'.$rows[0].'">'.$rows[0].'</a></td><td>'.$rows[1].'% chance</td></tr>';

                            } elseif ($rows[1]>=50) {
                                echo '<tr class="bg-warning dis" style="font-size:1.25rem;"><td><a style="color:white;" href="../Diseases/Clicked Disease.php#'.$rows[0].'">'.$rows[0].'</a></td><td>'.$rows[1].'% chance</td></tr>';

                            } elseif($rows[1]>=30){
                                echo '<tr class="dis" style="font-size:1rem;"><td><a href="../Diseases/Clicked Disease.php#'.$rows[0].'">'.$rows[0].'</a></td><td>'.$rows[1].'% chance</td></tr>';

                            } elseif($rows[1]>=15){
                                echo '<tr style="font-size:0.75rem;" class="dis"><td><a href="../Diseases/Clicked Disease.php#'.$rows[0].'">'.$rows[0].'</a></td><td>'.$rows[1].'% chance</td></tr>';   
