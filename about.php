...
<body>
    ...
    <div class="grid-container">
        <div class="Osvaldo">
            ...
            <img class="cover-photo" src="img/About_Images/Ozzy_Cover.jpg" alt="Osvaldo Sanchez Cover Photo">
            <p>
                <span class="b">Class:</span> Senior at SEMO
                <br>
                <span class="b">Degree:</span> CIS Bachelors
                <br>
                ...
                <br>
                <span class="b">My GitHub Link:</span> <a href="https://github.com/OASanchez" target="_blank"> https://github.com/OASanchez </a>
            </p>
        </div>
        <div class="Nick">
            <h2> Nick Mueth </h2>
            <img class="cover-photo" src="img/About_Images/Nick_Cover.jpg" alt="Nicholas Mueth Cover Photo">
            <p>
                <span class="b">Class:</span> Senior at SEMO
                <br>
                <span class="b">Degree:</span> CIS Bachelors
                ...
                <br>
                <span class="b">My GitHub Link:</span> <a href="https://github.com/NickMueth" target="_blank"> https://github.com/NickMueth </a>
            </p>
        </div>
        <div class="Josh">
            <h2> Joshua Toth </h2>
            <img class="cover-photo" src="img/About_Images/Josh_Cover.jpg" alt="Joshua Toth Cover Photo">
            <p>
                <span class="b">Class:</span> Senior at SEMO
                <br>
                <span class="b">Degree:</span> CIS Bachelors
                ...
                <br>
                <span class="b">My GitHub Link:</span> <a href="https://github.com/JcmToth" target="_blank"> https://github.com/JcmToth </a>
            </p>
        </div>
        <div class="Parfait">
            <h2> Parfait Domagni </h2>
            <img class="cover-photo" src="img/About_Images/Parfait_Cover.jpg" alt="Parfait Domagni Cover Photo">
            <p>
                <span class="b">Class:</span> Senior at SEMO
                <br>
                <span class="b">Degree:</span> CIS Bachelors
                ...
                <br>
                <br>
                <span class="b">My GitHub Link:</span> <br><a href="" target="_blank"> In Progress </a>
            </p>
        </div>
    </div>
